...
RONDAS_PATOLOGICAS = [
    ...
    Ronda(Carta(6, 'E'), Carta(1, 'E'), 1),
    Ronda(Carta(1, 'E'), Carta(7, 'E'), 1),
    Ronda(Carta(2, 'B'), Carta(1, 'E'), 1),
    Ronda(Carta('R', 'B'), Carta(1, 'E'), 1),
    Ronda(Carta(2, 'B'), Carta(3, 'O'), 2),
    Ronda(Carta(7, 'E'), Carta(7, 'O'), 2),
    Ronda(Carta(1, 'B'), Carta(7, 'O'), 2),
    Ronda(Carta(3, 'E'), Carta(2, 'C'), 2),
    Ronda(Carta(7, 'E'), Carta(3, 'C'), 2),
    Ronda(Carta('R', 'E'), Carta('S', 'B'), 3),
    Ronda(Carta('S', 'C'), Carta('C', 'O'), 3),
    Ronda(Carta('S', 'C'), Carta('C', 'B'), 3),
